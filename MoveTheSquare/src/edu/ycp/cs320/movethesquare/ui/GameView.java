...
public class GameView extends JPanel {
	private static final Color MIDNIGHT_BLUE = new Color(100, 30, 100); //changed color
	...
	protected void paintComponent(Graphics g) {
		...
		g.setColor(Color.CYAN); //chnaged color
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				square.setWidth(100.0); //change size
				square.setHeight(99.0);
